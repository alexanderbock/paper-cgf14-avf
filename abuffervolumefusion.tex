...
\author[S.~Lindholm et al.]%
		...
		Department of Science and Technology, 
		Link{\"o}ping University\\% 
		\{stefan.lindholm, martin.falk, erik.sunden, anders.ynnerman, timo.ropinski\}@liu.se}
...
\begin{figure}[t]
  ...
  % 
  \begin{minipage}{1.0\linewidth}\centering
    \includegraphics[width=\linewidth]{figures/plot-viewdep-mol-tall} 
  \end{minipage}
  % 
...
Due to a performance penalty associated with a CUDA/OpenGL context switch, we were unable to achieve results for the DFB on the same level as reported by Maule \etal~\cite{Maule2012}. 
...
\begin{figure}[t]
  ...
  % 
  \begin{minipage}{1.0\linewidth}\centering
    \includegraphics[width=\linewidth]{figures/plot-viewdep-quads-tall} 
  \end{minipage}
  \end{minipage}
